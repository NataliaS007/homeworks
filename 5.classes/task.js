class PrintEditionItem {
      ...
      for (const key in this.marks) {
        if (key !== subjectName) {
          ...
          return this.marks[key].reduce(
            (acc, item, index, arr) => acc + item / arr.length, 0)
        }
      }
    }
    getAverage () {
  ...
  let student2 = new Student('Alycia', 'female', 25)
  let student3 = new Student('Maxim', 'male', 30)
  
  let student = new Student('Alexander', 'male', 20)
